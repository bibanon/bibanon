...
NOTE: Thermites are generally very safe to mix and store. They are 
...
rendering the thermite useless. 

One way to fix this is to use a binder to 
...
minutes to melt all the sulfur. Pull it back out and mix it again.

While it is still hot, load into containers for use. When it cools, drill out the 
...
Heavly edited by: _--=PeEll=--_(tm)  When I found this phile it was one line
and it gave you an error that said devided by zero.
