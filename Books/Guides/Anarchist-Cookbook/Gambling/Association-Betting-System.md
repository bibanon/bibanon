...
* A horse must be able to handle the distance therefore it must be either a distance winner (indicated by a (D) ) or placed 2 lengths behind in a race within a furlong of todays distance or won a race within 1 furlong.
